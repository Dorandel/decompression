...
.requires(
    ...
    'game.entities.door'
    // 'game.rooms.airlock'
    // 'game.rooms.apartments',
    // 'game.rooms.armory',
    // 'game.rooms.bridge',
    // 'game.rooms.engineering',
    // 'game.rooms.hallway',
    // 'game.rooms.hangar',
    // 'game.rooms.hydroponics',
    // 'game.rooms.infirmary',
    // 'game.rooms.laboratories',
    // 'game.rooms.tycheCPC',
    // 'game.rooms.vrbay',
    // 'game.rooms.elbowA',
    // 'game.rooms.elbowB'
...
.defines(function(){
	...
	NewRoom = ig.Class.extend({
        ...
        setTiles: function() {
            ...
            this.tiles[Math.floor((Math.random() * 100) + 1)].setImage('lib/game/media/door.png');
            this.tiles[Math.floor((Math.random() * 100) + 1)].setImage('lib/game/media/door.png');
            this.tiles[Math.floor((Math.random() * 100) + 1)].setImage('lib/game/media/door.png');
        },
	});	
